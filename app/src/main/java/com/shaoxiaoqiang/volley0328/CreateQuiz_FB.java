...
public class CreateQuiz_FB extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_quiz__fb);
        ...
        btnSubmitquestion.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!question.isEmpty() && !optiona.isEmpty()) {
                    registerQuiz(question, optiona, optiona, optiona, optiona);
                } else {
        ...
        btnBacktomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CreateQuiz_FB.this, MainActivity.class);
     ...
     * */
    private void registerQuiz(final String question, final String optiona, final String optionb, final String optionc, final String optiond) {
        // Tag used to cancel the request
        String tag_string_req = "req_create_question";

        pDialog.setMessage("Creating Fill in Blanks Question ...");
        showDialog();
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                Log.d(TAG, "CreateQuestionFB Response: " + response.toString());
                hideDialog();
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        String optionb = quizquestion.getString("optionb");//Fill in Blanks, only optiona matters. Actual response should be all optionas.
                        ...
                        Intent intent = new Intent(CreateQuiz_FB.this, MainActivity.class);
                        CreateQuiz_FB.this.startActivity(intent);
                        finish();
                    } else {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("type", String.valueOf("Fill in Blanks"));
                return params;
            }
