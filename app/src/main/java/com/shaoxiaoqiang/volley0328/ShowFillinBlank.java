...
public class ShowFillinBlank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_fillin_blank);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent intent = new Intent(ShowFillinBlank.this, MainActivity.class);
                        ShowFillinBlank.this.startActivity(intent);
                        finish();
                    } else {
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(ShowFillinBlank.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
