...
public class CreateQuiz_TF extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_quiz__tf);
        ...
        btnSubmitquestion.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!question.isEmpty() && !optiona.isEmpty() && !optionb.isEmpty()) {
                    registerQuiz(question, optiona, optionb, optiona, optionb);
                } else {
        ...
        btnBacktomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CreateQuiz_TF.this, MainActivity.class);
    ...
    private void registerQuiz(final String question, final String optiona,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent intent = new Intent(CreateQuiz_TF.this, MainActivity.class);
                        CreateQuiz_TF.this.startActivity(intent);
                        finish();
                    } else {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("type", String.valueOf("True or False"));
                return params;
            }
