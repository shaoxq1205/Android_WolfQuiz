...
public class EditQuiz_F extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_quiz__f);
        ...
        btnUpdateQuiz.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!question.isEmpty() && !optiona.isEmpty() && !uid.isEmpty()) {
                    UpdateQuiz(question, optiona, uid);
                } else {
        ...
        btnAbortEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EditQuiz_F.this, ShowFillinBlank.class);
    ...
    private void UpdateQuiz(final String question, final String optiona, final String id) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_EDITQUESTION_F, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        Toast.makeText(getApplicationContext(), "Question successfully updated!",
